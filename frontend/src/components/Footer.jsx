...
const Footer = () => {
  ...
  if (isMobile) {
    // Mobile layout
    return (
      <footer ref={footerRef} className="bg-white text-[#18181B] w-full">
        <div className="bg-gray-50 px-6 py-8">
          ...
          <div className={`text-center mb-8 transition-all duration-1000 transform ${
            ...
            {/* Frames And Bows text below logo */}
            <h2 
              className="text-[32px] font-['Inter_Tight'] leading-none text-[#18181B]"
              style={{ 
                background: 'linear-gradient(180deg, rgba(24,24,27,0.9) 0%, rgba(24,24,27,0.4) 100%)',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent',
          ...
          <div className={`mb-8 transition-all duration-1000 transform ${
            ...
            <h3 className="text-lg font-bold font-satoshi mb-4 text-left">Contact</h3>
            
            {/* Location */}
            <div className="mb-4">
              <div className="flex items-start space-x-3">
                <svg className="w-4 h-4 mt-1 flex-shrink-0 text-gray-600" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                </svg>
                <div>
                  <p className="font-satoshi text-sm font-semibold text-gray-800 mb-1">LOCATION</p>
                  <p className="font-satoshi text-sm text-gray-600 leading-relaxed">
                    Rohtak, Haryana, India<br />
                    Available for custom consultations
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="font-satoshi text-sm font-semibold text-gray-800 mb-1">CALL US</p>
                  <a href="tel:+919149490169" className="font-satoshi text-sm text-gray-600 hover:text-[#a98028] transition-colors">
                    +91 9149490169
                  </a>
                </div>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="font-satoshi text-sm font-semibold text-gray-800 mb-1">EMAIL US</p>
                  <a href="mailto:framesandbowsofficial@gmail.com" className="font-satoshi text-sm text-gray-600 hover:text-[#a98028] transition-colors">
                    framesandbowsofficial@gmail.com
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className={`mb-8 transition-all duration-1000 transform ${
            ...
            <h3 className="text-lg font-bold font-satoshi mb-4 text-left">Products</h3>
            {loading ? (
              <p className="font-satoshi text-sm text-gray-600">Loading products...</p>
            ) : error ? (
              <p className="font-satoshi text-sm text-red-500">{error}</p>
            ) : (
              <div className="space-y-3">
                {products.slice(0, 8).map((product, index) => (
                  <Link 
                    to={`/product/${product._id}`} 
                    key={product._id} 
                    className={`block font-satoshi text-sm text-gray-600 hover:text-[#a98028] transition-all duration-300 ${
                      isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                    }`}
                ...
                {products.length > 8 && (
                  <Link 
                    to="/catalogue" 
                    className={`block font-satoshi text-sm text-[#a98028] font-semibold mt-3 transition-all duration-300 ${
                      isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                    }`}
                    style={{ transitionDelay: `${800 + (products.slice(0, 8).length * 50) + 100}ms` }}
                  >
                    View all products →
                  </Link>
                )}
          ...
          <div className={`border-t border-gray-200 pt-6 transition-all duration-1000 ${
            isVisible ? 'opacity-100' : 'opacity-0'
          }`} style={{ transitionDelay: '1000ms' }}>
            <p className="font-satoshi text-xs text-gray-500 text-center mb-4">
              © {currentYear} Frames And Bows. All Rights Reserved.
            </p>
            
            {/* Social Media Icons Centered */}
            <div className="flex justify-center space-x-4">
              <a href="https://www.instagram.com/framesandbowsofficial?igsh=MXYzdWdlaXppMHgwNA==" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-[#a98028] transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/>
                </svg>
              </a>
              <a href="https://wa.me/919149490169?text=Hi%20Sharika%2C%20%0AI%E2%80%99d%20like%20to%20enquire%20about%20your%20products" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-[#a98028] transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
