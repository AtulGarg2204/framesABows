    ...
    return (
      <footer ref={footerRef} className="bg-white text-[#18181B] w-full">
        <div className="bg-gray-50 px-6 py-8">
          {/* Logo and branding aligned to left */}
          <div className={`text-left mb-8 transition-all duration-1000 transform ${
          ...
          <div className={`mb-8 transition-all duration-1000 transform ${
            ...
            <h3 className="text-lg font-bold font-satoshi mb-4 text-left">Latest Products</h3>
            {loading ? (
