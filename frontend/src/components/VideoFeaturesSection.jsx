...
const VideoFeaturesSection = () => {
  ...
  if (isMobile) {
    // Mobile layout - image on top, features stacked vertically
    return (
      <section className="py-8 bg-white" ref={sectionRef}>
        <div className="mx-auto max-w-sm px-6">
          ...
          <div className="text-center mb-8">
            <h2 
              className={`text-2xl font-playfair text-[#18181B] mb-3 transition-all duration-1000 leading-tight ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
              style={{ transitionDelay: '200ms' }}
            >
              Reflections of Timeless Craftsmanship
            </h2>
            <div 
              className={`w-16 h-1 bg-[#a98028] mx-auto transition-all duration-1000 ${
          ...
          {/* Image carousel */}
          <div className="mb-8">
            <div className={`relative w-full aspect-[4/5] bg-gray-100 rounded-lg overflow-hidden shadow-xl transition-all duration-1000 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}>
              {/* Carousel container */}
                  ...
                  >
                    <img 
                      ...
                      onError={(e) => {
                        ...
                        e.target.parentElement.style.background = 'linear-gradient(135deg, #f3f4f6 0%, #e5e7eb 100%)';
                      }}
                    />
                  </div>
                ))}
          ...
          <div className="space-y-6">
            {/* Feature 1 */}
            <div className={`bg-gray-50 p-6 rounded-lg transition-all duration-1000 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`} style={{ transitionDelay: '200ms' }}>
              <div className="text-[#a98028] mb-3">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
              </div>
              <h3 className="text-xl font-playfair text-[#18181B] mb-2">Made by artists</h3>
              <p className="text-sm text-[#323030] font-satoshi leading-relaxed">Each piece is handcrafted with artistry and tradition.</p>
            </div>
            ...
            <div className={`bg-gray-50 p-6 rounded-lg transition-all duration-1000 ${
              ...
              <h3 className="text-xl font-playfair text-[#18181B] mb-2">Sustainable Elegance</h3>
              <p className="text-sm text-[#323030] font-satoshi leading-relaxed">A timeless design for your home.</p>
            </div>
            ...
            <div className={`bg-gray-50 p-6 rounded-lg transition-all duration-1000 ${
              ...
              <h3 className="text-xl font-playfair text-[#18181B] mb-2">100% Freshness</h3>
              <p className="text-sm text-[#323030] font-satoshi leading-relaxed">Our designs seamlessly integrate with any interior.</p>
            </div>
            ...
            <div className={`bg-gray-50 p-6 rounded-lg transition-all duration-1000 ${
              ...
              <h3 className="text-xl font-playfair text-[#18181B] mb-2">Locally produced</h3>
              <p className="text-sm text-[#323030] font-satoshi leading-relaxed">Bespoke options to match your specific needs.</p>
            </div>
          </div>
        </div>
      </section>
  ...
  return (
    <section className="py-12 bg-white px-[20px] sm:px-0 md:px-0 lg:px-[100px]" ref={sectionRef}>
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="text-center mb-8">
          <h2 
            className={`text-[32px] lg:text-[52px] font-playfair text-[#18181B] mb-3 transition-all duration-1000 leading-tight ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
            style={{ transitionDelay: '200ms' }}
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-4">
          ...
          <div className="grid grid-cols-2 gap-x-16 gap-y-20 bg-gray-50 p-12 rounded-lg w-full">
            ...
            <div className={`transition-all duration-1000 ${
              ...
              <div className="text-[#a98028] mb-6">
